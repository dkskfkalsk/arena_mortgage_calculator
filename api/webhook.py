    ...
    if application is None:
        ...
        async def help_command(update, context):
            ...
            help_message = (
                ...
                "1️⃣ 부족자금 산출\n"
                "요청사항에 '부족자금' 또는 '부족금 마련' 입력 시 마이너스 한도도 산출됩니다.\n\n"
                ...
                "3️⃣ 사업자금 표기\n"
                "설정내역에서 대환할 기관명에 '(사업자금)' 표기 필요\n"
                "(MG캐피탈, OK저축은행, 애큐온저축은행, BNK캐피탈 등)\n"
                "예: 2순위 : 홀인원캐피탈대부(사업자금) 44,800만원\n\n"
                
                "4️⃣ 하한가 자동 적용\n"
                "KB시세에 하한가가 있으면 조건에 따라 자동 적용됩니다.\n"
                "적용 시 금융사명 옆에 '(하한가 적용)' 표시\n\n"
                
                "5️⃣ 탁감가 사용\n"
                "특이사항에 '탁감가 80,000만원' 또는 '감정가 8억' 형식으로 입력\n"
                "(금융사별 사용 여부 상이)\n\n"
                ...
                "7️⃣ 후순위/선순위\n"
                "요청사항에 '후순위', '선순위 대환', '전액 대환', '추가대출' 입력\n\n"
                
                "8️⃣ 취급 불가 키워드\n"
                "특이사항에 '압류', '가압류', '경매취하자금' 있으면 취급 불가\n\n"
                
                "9️⃣ PDF 등기부등본 분석\n"
                "특정 채널에서 PDF 업로드 시 자동 분석 및 KB 시세 조회\n\n"
                
                "🔟 신용점수 없을 때\n"
                "신용점수가 'X'이거나 없으면 금리 범위로 표시됩니다."
            )
            try:
