...
COMMON_BASE = {
    ...
    "tenant_subordinate_allowed": True,
    "_comment_tenant_subordinate_allowed": "세입자 있는 후순위 취급 허용",
    "tenant_consent_caption": "※ 전,월세 동의·미동의 진행 가능",
    "_comment_tenant_consent_caption": "세입자 있을 때 한도 밑에 동의/미동의 가능 안내",
